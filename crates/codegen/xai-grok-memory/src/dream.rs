...
7. **Generalize** task narratives into reusable mechanisms, rules, and root causes
8. **Ground details** — use stable repo-relative paths for project structure; include an absolute \
